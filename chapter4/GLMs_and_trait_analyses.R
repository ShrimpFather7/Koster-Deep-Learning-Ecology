...
unique_traits <- unique(my_data$median_temp)
...
for (trait in unique_traits) {
  ...
  traitmodel_results[[trait]] <- create_traitmodel(my_data$median_temp,trait, my_data)
}                                             # Change trait here!
...
# For lifestyle, SSF = Sessile Suspension-Feeders, and MS = Mobile Scavengers
